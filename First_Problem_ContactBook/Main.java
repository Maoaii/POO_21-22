...
public class Main {
	//Constantes que definem os comandos
	 ...
	 public static final String SEARCH_NAME	   = "GN";
	 public final static String SAME_NUMBER    = "EP";
	 ...
	 public static final String MULTIPLE_SAME_NUMBER = "There are contacts that share phone numbers.";
	 public static final String NO_SAME_NUMBER = "All contacts have different phone numbers.";
	...
	/**
	 * Searches the name of a person by its' phone number
	 * 
	 * @param in: input reader
	 * @param cBook: contact book
	 * @pre cBook.getNumberOfContacts() != 0
	 * @pre in != null && cBook != null
	 */
	private static void searchName(Scanner in, ContactBook cBook) {
	...
	/**
	 * Checks if there are atleast two people with the same phone number
	 * 
	 * @param cBook: contact book
	 * @pre cBook != null
	 */
	private static void searchSameNumber(ContactBook cBook) {
		if (cBook.isThereSameNumber()) {
			System.out.println(MULTIPLE_SAME_NUMBER);
		}
		else {
			System.out.println(NO_SAME_NUMBER);
		}
	}
}
